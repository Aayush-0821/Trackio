    ...
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      {!isEmailSent &&
        <form onSubmit={onSubmitEmail} className='bg-slate-800 p-8 rounded-lg shadow-lg w-96 text-sm'>
          <p className='text-white text-2xl font-semibold text-center mb-4'>Reset Password</p>
          ...
          <button className='w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-800 text-white rounded-full mt-3 cursor-pointer'>Submit</button>
        </form>
      }
      {/* otp input form */}
      {!isOtpSubmitted && isEmailSent &&
        <form onSubmit={onSubmitOtp}  className='bg-slate-800 p-8 rounded-lg shadow-lg w-96 text-sm'>
          <p className='text-white text-2xl font-semibold text-center mb-4'>Reset Password OTP</p>
          ...
          <button className='w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-800 text-white rounded-full cursor-pointer'>Submit</button>
        </form>
      }
      {/* enter new password */}
      {isOtpSubmitted && isEmailSent &&
        <form onSubmit={onSubmitNewPassword} className='bg-slate-800 p-8 rounded-lg shadow-lg w-96 text-sm'>
          <p className='text-white text-2xl font-semibold text-center mb-4'>New Password</p>
